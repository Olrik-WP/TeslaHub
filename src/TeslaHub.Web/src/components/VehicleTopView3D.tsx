    ...
    if (wrapUrl) {
      ...
      console.log(
        ...
        (uvMeshCount > 0
          ...
          : 'NO UVs found on this GLB — wrap will sample a single pixel and ' +
            'render flat. Re-run optimize-glb.ps1 with --keep-attributes true ' +
            '(see optimize-glb.ps1 header for the rationale).'),
      );
    }
