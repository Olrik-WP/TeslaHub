  ...
  const envSnippet = useMemo(
    () =>
      [
        ...
        '# Region: "global" (default) or "china". China needs a separate',
        '# developer app created on developer.tesla.cn (+86 phone required).',
        'TESLA_REGION=global',
        ...
        '#   China: https://fleet-api.prd.cn.vn.cloud.tesla.cn   (auto with TESLA_REGION=china)',
